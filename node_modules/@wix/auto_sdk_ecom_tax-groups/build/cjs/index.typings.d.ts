 ...
 */
declare function createTaxGroup(taxGroup: NonNullablePaths<TaxGroup, `name`, 2>): Promise<NonNullablePaths<TaxGroup, `name`, 2>>;
/**
 ...
 */
declare function getTaxGroup(taxGroupId: string): Promise<NonNullablePaths<TaxGroup, `name`, 2>>;
/**
 * Updates a tax group.
 *
 ...
 */
declare function updateTaxGroup(_id: string, taxGroup: NonNullablePaths<UpdateTaxGroup, `name` | `revision`, 2>): Promise<NonNullablePaths<TaxGroup, `name`, 2> & {
 ...
 */
declare function listDefaultTaxGroups(): Promise<NonNullablePaths<ListDefaultTaxGroupsResponse, `taxGroups` | `taxGroups.${number}.name`, 4>>;
/**
