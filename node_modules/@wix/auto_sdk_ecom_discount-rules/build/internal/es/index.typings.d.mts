...
interface TieredPrice {
    /**
     * list of tier options. Currently single tier is supported.
     * @minSize 1
     * @maxSize 1
     */
    tiers?: Tier[];
...
interface Tier {
    ...
    quantity?: number;
    /**
     * The tiered price of the tier price (Represents Amount).
     * @decimalValue options { gte:0, lte:1000000000000000, maxScale:4 }
     */
    price?: string;
}
