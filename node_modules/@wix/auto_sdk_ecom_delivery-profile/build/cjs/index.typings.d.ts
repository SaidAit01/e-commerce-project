...
interface DeliveryProfilesQueryBuilder {
     ...
     * @documentationMaturity preview
     */
    eq: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    ne: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    ge: (propertyName: '_id' | 'name' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    gt: (propertyName: '_id' | 'name' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    le: (propertyName: '_id' | 'name' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    lt: (propertyName: '_id' | 'name' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `string`.
     * @param string - String to compare against. Case-insensitive.
     * @documentationMaturity preview
     */
    startsWith: (propertyName: '_id' | 'name', value: string) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `values`.
     * @param values - List of values to compare against.
     * @documentationMaturity preview
     */
    hasSome: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate', value: any[]) => DeliveryProfilesQueryBuilder;
    /** @documentationMaturity preview */
    in: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @documentationMaturity preview */
    exists: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate', value: boolean) => DeliveryProfilesQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
     * @documentationMaturity preview
     */
    ascending: (...propertyNames: Array<'_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate'>) => DeliveryProfilesQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
     * @documentationMaturity preview
     */
    descending: (...propertyNames: Array<'_id' | 'name' | 'default' | 'createdBy' | '_createdDate' | '_updatedDate'>) => DeliveryProfilesQueryBuilder;
