...
// src/ecommerce-currency-converter-v1-currency-rate-currencies.meta.ts
function listCurrencies2() {
  const payload = {};
  const getRequestOptions = listCurrencies(
    payload
  );
...
function convertCurrency2() {
  ...
  const getRequestOptions = convertCurrency(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function getConversionRate() {
  const payload = { from: ":from", to: ":to" };
  const getRequestOptions = conversionRate(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
