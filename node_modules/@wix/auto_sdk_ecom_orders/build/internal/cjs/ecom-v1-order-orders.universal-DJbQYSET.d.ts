 ...
 */
declare function getRefundabilityStatus(ecomOrderId: string): Promise<NonNullablePaths<GetRefundabilityStatusResponse, `refundabilities` | `refundabilities.${number}.nonRefundableReason` | `refundabilities.${number}.manuallyRefundableReason` | `refundabilities.${number}.paymentId` | `refundabilities.${number}.refundabilityStatus` | `refundablePerItem`, 4>>;
/**
 ...
 */
declare function aggregateOrders(options?: NonNullablePaths<AggregateOrdersOptions, `aggregation`, 2>): Promise<AggregateOrdersResponse>;
