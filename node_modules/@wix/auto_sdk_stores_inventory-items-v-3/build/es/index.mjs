...
var onInventoryItemCreated2 = createEventModule(
  onInventoryItemCreated
);
var onInventoryItemDeleted2 = createEventModule(
  onInventoryItemDeleted
);
var onInventoryItemStockStatusUpdated2 = createEventModule(
  onInventoryItemStockStatusUpdated
);
var onInventoryItemUpdated2 = createEventModule(
  onInventoryItemUpdated
);
var onInventoryItemUpdatedWithReason2 = createEventModule(
