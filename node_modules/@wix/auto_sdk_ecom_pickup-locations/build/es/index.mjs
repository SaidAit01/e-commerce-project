...
async function createPickupLocation2(pickupLocation) {
  ...
  const payload = transformPaths2(
    renameKeysFromSDKRequestToRESTRequest({ pickupLocation }),
    [
      {
...
async function bulkCreatePickupLocation2(pickupLocations) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = transformPaths2(
    renameKeysFromSDKRequestToRESTRequest({ pickupLocations }),
    [
      {
        transformFn: transformSDKAddressToRESTAddress,
        paths: [{ path: "pickupLocations.address" }]
...
var createPickupLocation4 = /* @__PURE__ */ createRESTModule(createPickupLocation3);
var getPickupLocation4 = /* @__PURE__ */ createRESTModule(getPickupLocation3);
var updatePickupLocation4 = /* @__PURE__ */ createRESTModule(updatePickupLocation3);
var deletePickupLocation4 = /* @__PURE__ */ createRESTModule(deletePickupLocation3);
var queryPickupLocation4 = /* @__PURE__ */ createRESTModule(queryPickupLocation3);
...
var bulkCreatePickupLocation4 = /* @__PURE__ */ createRESTModule(bulkCreatePickupLocation3);
var bulkUpdatePickupLocation4 = /* @__PURE__ */ createRESTModule(bulkUpdatePickupLocation3);
var bulkDeletePickupLocation4 = /* @__PURE__ */ createRESTModule(bulkDeletePickupLocation3);
export {
  ConditionType,
  LogicalOperator,
  SortOrder,
  ...
  bulkCreatePickupLocation4 as bulkCreatePickupLocation,
  bulkDeletePickupLocation4 as bulkDeletePickupLocation,
  bulkUpdatePickupLocation4 as bulkUpdatePickupLocation,
  createPickupLocation4 as createPickupLocation,
  deletePickupLocation4 as deletePickupLocation,
  getPickupLocation4 as getPickupLocation,
  queryPickupLocation4 as queryPickupLocation,
  removeDeliveryRegion4 as removeDeliveryRegion,
  updatePickupLocation4 as updatePickupLocation
};
