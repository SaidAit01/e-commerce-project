...
export const CurrentCartService = implementService.withConfig()(CurrentCartServiceDefinition, ({ getService, config }) => {
    ...
    const isOpen = signalsService.signal(false);
    ...
    const applyCoupon = async (couponCode) => {
        try {
            ...
            if (err?.details?.applicationError?.code === "ERROR_COUPON_DOES_NOT_EXIST") {
            ...
            else if (err?.details?.applicationError?.code === "ERROR_COUPON_NOT_APPLICABLE") {
