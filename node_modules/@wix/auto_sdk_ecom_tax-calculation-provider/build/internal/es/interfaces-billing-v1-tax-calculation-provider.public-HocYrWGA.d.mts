...
interface CalculateTaxEnvelope {
...
declare const provideHandlers: ServicePluginDefinition<{
    ...
    calculateTax(payload: CalculateTaxEnvelope): CalculateTaxResponse | Promise<CalculateTaxResponse>;
}>;

export { type Address as A, type CalculateTaxRequest as C, IdentityType as I, JurisdictionType as J, type LineItem as L, type MultipleAddresses as M, type SpiBaseUri as S, type TaxSummary as T, type AddressIndex as a, type AddressIndexAddressIndexOptionsOneOf as b, type CalculateTaxResponse as c, type LineItemTaxDetails as d, type TaxBreakdown as e, type LineItemTaxSummary as f, type TaxCalculationConfig as g, type AlternativeUri as h, type Context as i, type IdentificationData as j, type IdentificationDataIdOneOf as k, type CalculateTaxEnvelope as l, provideHandlers as p };
