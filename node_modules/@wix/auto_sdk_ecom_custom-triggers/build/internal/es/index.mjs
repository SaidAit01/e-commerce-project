...
// src/interfaces-ecommerce-v1-custom-trigger.public.ts
import { ServicePluginDefinition } from "@wix/sdk-types";
import {
  renameKeysFromSDKRequestToRESTRequest,
  renameKeysFromRESTResponseToSDKResponse
} from "@wix/sdk-runtime/rename-all-nested-keys";
var provideHandlers = ServicePluginDefinition("ECOM_DISCOUNTS_TRIGGER", [
  {
    name: "listTriggers",
...
// src/interfaces-ecommerce-v1-custom-trigger.context.ts
