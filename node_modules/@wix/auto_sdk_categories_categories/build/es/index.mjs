...
function getCategory3(httpClient) {
  return (categoryId, treeReference, options) => getCategory2(
    categoryId,
    treeReference,
    options,
    // @ts-ignore
...
function deleteCategory3(httpClient) {
  return (categoryId, treeReference) => deleteCategory2(
    categoryId,
    treeReference,
    // @ts-ignore
    { httpClient }
...
function moveCategory3(httpClient) {
  return (categoryId, treeReference, options) => moveCategory2(
    categoryId,
    treeReference,
    options,
    // @ts-ignore
...
function bulkUpdateCategories3(httpClient) {
  return (categories, options) => bulkUpdateCategories2(
    categories,
    options,
    // @ts-ignore
    { httpClient }
...
function updateCategoryVisibility3(httpClient) {
  return (categoryId, options) => updateCategoryVisibility2(
    categoryId,
    options,
    // @ts-ignore
    { httpClient }
...
function bulkShowCategories3(httpClient) {
  return (categoryIds, options) => bulkShowCategories2(
    categoryIds,
    options,
    // @ts-ignore
    { httpClient }
...
function bulkAddItemsToCategory3(httpClient) {
  return (categoryId, items, options) => bulkAddItemsToCategory2(
    categoryId,
    items,
    options,
    // @ts-ignore
...
function bulkAddItemToCategories3(httpClient) {
  return (item, options) => bulkAddItemToCategories2(
    item,
    options,
    // @ts-ignore
    { httpClient }
...
function bulkRemoveItemsFromCategory3(httpClient) {
  return (categoryId, items, options) => bulkRemoveItemsFromCategory2(
    categoryId,
    items,
    options,
    // @ts-ignore
...
function bulkRemoveItemFromCategories3(httpClient) {
  return (item, options) => bulkRemoveItemFromCategories2(
    item,
    options,
    // @ts-ignore
    { httpClient }
...
function listItemsInCategory3(httpClient) {
  return (categoryId, treeReference, options) => listItemsInCategory2(
    categoryId,
    treeReference,
    options,
    // @ts-ignore
...
function listCategoriesForItem3(httpClient) {
  return (item, options) => listCategoriesForItem2(
    item,
    options,
    // @ts-ignore
    { httpClient }
...
function listCategoriesForItems3(httpClient) {
  return (items, options) => listCategoriesForItems2(
    items,
    options,
    // @ts-ignore
    { httpClient }
...
function listTrees3(httpClient) {
  return () => listTrees2(
    // @ts-ignore
    { httpClient }
  );
}
function setArrangedItems3(httpClient) {
  return (categoryId, treeReference, options) => setArrangedItems2(
    categoryId,
    treeReference,
    options,
    // @ts-ignore
...
function getArrangedItems3(httpClient) {
  return (categoryId, treeReference) => getArrangedItems2(
    categoryId,
    treeReference,
    // @ts-ignore
    { httpClient }
...
var onCategoryMoved = EventDefinition(
...
var onCategoryItemAddedToCategory = EventDefinition(
...
var onCategoryItemRemovedFromCategory = EventDefinition(
...
var onCategoryItemsArrangedInCategory = EventDefinition(
...
var searchCategories4 = /* @__PURE__ */ createRESTModule(searchCategories3);
var countCategories4 = /* @__PURE__ */ createRESTModule(countCategories3);
var moveCategory4 = /* @__PURE__ */ createRESTModule(moveCategory3);
var bulkUpdateCategories4 = /* @__PURE__ */ createRESTModule(bulkUpdateCategories3);
var updateCategoryVisibility4 = /* @__PURE__ */ createRESTModule(updateCategoryVisibility3);
var bulkShowCategories4 = /* @__PURE__ */ createRESTModule(bulkShowCategories3);
var bulkAddItemsToCategory4 = /* @__PURE__ */ createRESTModule(bulkAddItemsToCategory3);
var bulkAddItemToCategories4 = /* @__PURE__ */ createRESTModule(bulkAddItemToCategories3);
var bulkRemoveItemsFromCategory4 = /* @__PURE__ */ createRESTModule(bulkRemoveItemsFromCategory3);
var bulkRemoveItemFromCategories4 = /* @__PURE__ */ createRESTModule(bulkRemoveItemFromCategories3);
var listItemsInCategory4 = /* @__PURE__ */ createRESTModule(listItemsInCategory3);
var listCategoriesForItem4 = /* @__PURE__ */ createRESTModule(listCategoriesForItem3);
var listCategoriesForItems4 = /* @__PURE__ */ createRESTModule(listCategoriesForItems3);
var listTrees4 = /* @__PURE__ */ createRESTModule(listTrees3);
var setArrangedItems4 = /* @__PURE__ */ createRESTModule(setArrangedItems3);
var getArrangedItems4 = /* @__PURE__ */ createRESTModule(getArrangedItems3);
var bulkSetItemCategories4 = /* @__PURE__ */ createRESTModule(bulkSetItemCategories3);
var onCategoryMoved2 = createEventModule(onCategoryMoved);
var onCategoryCreated2 = createEventModule(onCategoryCreated);
var onCategoryDeleted2 = createEventModule(onCategoryDeleted);
var onCategoryItemAddedToCategory2 = createEventModule(
  onCategoryItemAddedToCategory
);
var onCategoryItemRemovedFromCategory2 = createEventModule(
  onCategoryItemRemovedFromCategory
);
var onCategoryItemsArrangedInCategory2 = createEventModule(
...
export {
  ...
  Width,
  WidthType,
  bulkAddItemToCategories4 as bulkAddItemToCategories,
  bulkAddItemsToCategory4 as bulkAddItemsToCategory,
  bulkRemoveItemFromCategories4 as bulkRemoveItemFromCategories,
  bulkRemoveItemsFromCategory4 as bulkRemoveItemsFromCategory,
  bulkSetItemCategories4 as bulkSetItemCategories,
  bulkShowCategories4 as bulkShowCategories,
  bulkUpdateCategories4 as bulkUpdateCategories,
  countCategories4 as countCategories,
  createCategory4 as createCategory,
  deleteCategory4 as deleteCategory,
  getArrangedItems4 as getArrangedItems,
  getCategory4 as getCategory,
  listCategoriesForItem4 as listCategoriesForItem,
  listCategoriesForItems4 as listCategoriesForItems,
  listItemsInCategory4 as listItemsInCategory,
  listTrees4 as listTrees,
  moveCategory4 as moveCategory,
  onCategoryCreated2 as onCategoryCreated,
  onCategoryDeleted2 as onCategoryDeleted,
  onCategoryItemAddedToCategory2 as onCategoryItemAddedToCategory,
  onCategoryItemRemovedFromCategory2 as onCategoryItemRemovedFromCategory,
  onCategoryItemsArrangedInCategory2 as onCategoryItemsArrangedInCategory,
  onCategoryMoved2 as onCategoryMoved,
  onCategoryUpdated2 as onCategoryUpdated,
  queryCategories4 as queryCategories,
  searchCategories4 as searchCategories,
  setArrangedItems4 as setArrangedItems,
  updateCategory4 as updateCategory,
  updateCategoryVisibility4 as updateCategoryVisibility
};
